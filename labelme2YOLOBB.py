...
def convert_labelme_to_yolo(json_path, output_path, class_names):
...
def main():
    ...
    for filename in glob.glob(osp.join(args.input_dir, "*.json")):
        ...
        out_yolo_file = osp.join(args.output_dir, "labels", base + ".txt")

        convert_labelme_to_yolo(filename, out_yolo_file, class_names)
        if not args.noviz:
